...
TUHSD://hackath.on/2023/full-stack-connecting-the-pieces
...
5m to cover building and serving the FE
...
5m to cover updating FE to hit the api
</Notes>
...
5m to cover setting up heroku deploy
